...
2. The response: you can return either the created user or just a success message.
...
**NOTE:** have in mind that anyone can create a JWT token with any payload data they want, but only those who have the secret can generate the right signature. Only the server should know this secret.
